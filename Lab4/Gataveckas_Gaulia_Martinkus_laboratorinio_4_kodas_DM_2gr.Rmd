...
aft <- aftreg(Surv(tenure, censured) ~ phone_service + dependents + internet_service + female +
  senior_citizen + monthly_charges,
data = x, dist = "weibull", shape = 1
) # eksponentinis skirstinys

aft2 <- aftreg(Surv(tenure, censured) ~ phone_service + dependents + internet_service + female +
  senior_citizen + monthly_charges,
data = x, dist = "weibull"
)


aft3 <- aftreg(Surv(tenure, censured) ~ phone_service + dependents + internet_service + female +
  senior_citizen + monthly_charges,
data = x, dist = "lognormal"
)


aft4 <- aftreg(Surv(tenure, censured) ~ phone_service + dependents + internet_service + female +
  senior_citizen + monthly_charges,
